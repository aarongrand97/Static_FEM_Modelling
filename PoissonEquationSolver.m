function [c] = PoissonEquationSolver(x_min, x_max, NElem, D, f, bndry_1, bndry_1_val, bndry_2, bndry_2_val)
...
for elemId = 1 : NElem
    ...
    RHS(elemId) = RHS(elemId) - f*msh.elem(elemId).J;
    RHS(elemId+1) = RHS(elemId+1) - f*msh.elem(elemId).J;
end
